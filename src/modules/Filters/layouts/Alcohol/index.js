...
class AlcoholLayout extends Component {

    render() {
        const { history, beers, loading, updateList, changeSelected, activeRadio, onChangeTextInput, searchByAlcohol } = this.props;
        return (
            <View style={ { height: Dimensions.get('window').height } }>
                ...
                <View style={ {
                    ...
                    <TouchableOpacity style={ { flex: 2 } } onPress={ () => searchByAlcohol() }>
                        <Button>
